...
<a href="https://www.github.com/karon16" target="_blank" rel="noreferrer">
  <img src="https://raw.githubusercontent.com/danielcranney/readme-generator/main/public/icons/socials/github-dark.svg" width="28" height="28" alt="GitHub" />
</a>
&nbsp;
<a href="https://www.linkedin.com/in/christopher-buhendwa-1b7851149/" target="_blank" rel="noreferrer">
  <img src="https://raw.githubusercontent.com/danielcranney/readme-generator/main/public/icons/socials/linkedin-dark.svg" width="28" height="28" alt="LinkedIn" />
</a>
&nbsp;
<a href="mailto:christopherbuhendwa2000@gmail.com">
...
| **Currently focused on** | Agentic AI & RAG systems |
| **Mission** | Applying AI to social impact problems in under-resourced communities |
| **Portfolio** | [christopher-buhendwa.vercel.app](https://christopher-buhendwa.vercel.app) |
| **Reach me at** | [christopherbuhendwa2000@gmail.com](mailto:christopherbuhendwa2000@gmail.com) |
...
**JusticeCongo AI**
French-language legal RAG platform for a Congolese NGO, built on hybrid BM25 + pgvector retrieval with multilingual NLP.

`Python` `RAG` `pgvector` `NLP`

[Repository](https://github.com/karon16/legal_documents_RAG)

</td>
<td width="50%" valign="top">

**No-LLaVA — Multimodal Crisis Mapping**
CLIP-based dual-encoder system for disaster intelligence extraction from social media, accepted at KCC 2026.

`Computer Vision` `Multimodal AI` `Attention Fusion`

[Repository](https://github.com/karon16/crisis-mapping-frontend)
...
**ClubHub**
Club discovery and application platform for university students, built with Next.js and Supabase.

`Next.js` `Node.js` `Supabase`

[Live Site](https://handong-club-hub.vercel.app/)

</td>
<td width="50%" valign="top">

**Jikjjang**
Flutter mobile app connecting job-seeking foreigners in Korea with AI-driven career guidance.

`Flutter` `Dart` `AI Career Guidance`
